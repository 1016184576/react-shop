    ...
    return (
      <div className={styles['page']}>
        ...
        <div className={styles['header']}>
          <div className={styles['classify-icon']}></div>
          <div className={styles['search-wrap']}>
            <div className={styles['search-icon']}></div>
            <div className={styles['text']}>请输入宝贝名称</div>
          </div>
        ...
        {/* 潮流女装 */}
        <div className={styles["goods-level-wrap"]}>
          <div className={styles["classify-title"] + styles["color1"]}>—— 潮流女装 ——</div>
          <div className={styles["goods-level1-wrap"]}>
            <div className={styles["goods-level1-item0"]}>
              <div className={styles["goods-title"]}>高跟鞋女2018新款春季单鞋仙女甜美链子尖头防水台细跟女鞋一字带</div>
              <div className={styles["goods-text"]}>精品打折</div>
              <div className={styles["goods-price1"]}>12.8元</div>
              <div className={styles["goods-img"]}>
                <img src="//vueshop.glbuys.com/uploadfiles/1524556409.jpg" alt="高跟鞋女2018新款春季单鞋仙女甜美链子尖头防水台细跟女鞋一字带" />
              </div>
            </div>
            <div className={styles["goods-level1-item1"]}>
              <div className={styles["goods-row"]}>
                <div className={styles["goods-row-title"]}>欧美尖头蝴蝶结拖鞋女夏外穿2018新款绸缎面细跟凉拖半拖鞋穆勒鞋</div>
                <div className={styles["goods-row-text"]}>品质精挑</div>
                <div className={styles["goods-row-img"]}>
                  <img src="//vueshop.glbuys.com/uploadfiles/1524556315.jpg" alt="欧美尖头蝴蝶结拖鞋女夏外穿2018新款绸缎面细跟凉拖半拖鞋穆勒鞋" />
                </div>
              </div>
              <div className={styles["goods-row"]}>
                <div className={styles["goods-row-title"]}>老爹鞋女韩版ulzzang原宿百搭网鞋透气网面内增高运动鞋网鞋夏季
              </div>
                <div className={styles["goods-row-text"]}>品质精挑</div>
                <div className={styles["goods-row-img"]}><img src="//vueshop.glbuys.com/uploadfiles/1524556213.jpg" alt="老爹鞋女韩版ulzzang原宿百搭网鞋透气网面内增高运动鞋网鞋夏季" />
                </div>
              </div>
            </div>
          </div>
          <div className={styles["goods-list-wrap"]}>
            <div className={styles["goods-list"]}>
              <div className={styles["title"]}>小白鞋女2018春夏季新款韩版百搭平底学生原宿ulzzang帆布鞋板鞋</div>
              <div className={styles["image"]}><img src="//vueshop.glbuys.com/uploadfiles/1524556119.jpg" alt="小白鞋女2018春夏季新款韩版百搭平底学生原宿ulzzang帆布鞋板鞋" /></div>
              <div className={styles["price"]}>¥288</div>
              <div className={styles["unprice"]}>¥576</div>
            </div>
            <div className={styles["goods-list"]}>
              <div className={styles["title"]}>雪兰黛2018春季新款高跟鞋尖头细跟性感鞋子女韩版透气纱网女单鞋 </div>
              <div className={styles["image"]}><img src="//vueshop.glbuys.com/uploadfiles/1524556026.jpg" alt="雪兰黛2018春季新款高跟鞋尖头细跟性感鞋子女韩版透气纱网女单鞋 " /></div>
              <div className={styles["price"]}>¥280</div>
              <div className={styles["unprice"]}>¥560</div>
            </div>
            <div className={styles["goods-list"]}>
              <div className={styles["title"]}>2018夏季新款韩版百搭高跟鞋女显瘦细跟黑色工作鞋金属扣露趾凉鞋</div>
              <div className={styles["image"]}><img src="//vueshop.glbuys.com/uploadfiles/1524555954.jpg" alt="2018夏季新款韩版百搭高跟鞋女显瘦细跟黑色工作鞋金属扣露趾凉鞋" /></div>
              <div className={styles["price"]}>¥300</div>
              <div className={styles["unprice"]}>¥600</div>
            </div>
            <div className={styles["goods-list"]}>
              <div className={styles["title"]}>2018新款韩版高跟鞋女凉鞋夏细跟尖头一字扣猫跟鞋包头百搭磨砂皮</div>
              <div className={styles["image"]}><img src="//vueshop.glbuys.com/uploadfiles/1524555891.jpg" alt="2018新款韩版高跟鞋女凉鞋夏细跟尖头一字扣猫跟鞋包头百搭磨砂皮" /></div>
              <div className={styles["price"]}>¥200</div>
              <div className={styles["unprice"]}>¥400</div>
            </div>
          </div>
        </div>
        ...
        {/* 品牌男装 */}
        <div className={styles["goods-level-wrap"]}>
          <div className={styles["classify-title"] + ["color2"]}>
            —— 品牌男装 ——
          </div>
          <div className={styles["goods-level1-wrap"]}>
            <div className={styles["goods-level1-item0"]}>
              <div className={styles["goods-title2"]}>
                新款短袖男士夏季3d立体图案体恤猴子搞怪大猩猩个性t恤大码衣服
              </div>
              <div className={styles["goods-text2"]}>
                火爆开售
              </div>
              <div className={styles["goods-img2"]}>
        ...
        {/* 电脑办公 */}
        <div className={styles["goods-level-wrap"]}>
          <div className={styles["classify-title"] + ["color3"]}>
            —— 电脑办公 ——
          </div>
          <div className={styles["goods-level1-wrap"]}>
            <div className={styles["goods-level1-item0"]}>
            ...
            <div className={styles["goods-price3"]}>
              4599元
            </div>
            <div className={styles["goods-img"]}>
            ...
            <div className={styles["goods-level1-item1"]}>
            <div className={styles["goods-row"]}>
              <div className={styles["goods-row-title"]}>
              金属鼠标垫个性定制LOGO大号高贵时尚航空级铝合金圆形游戏办公批
              </div>
              <div className={styles["goods-row-text"]}>
              品质精挑
              </div>
              <div className={styles["goods-row-img"]}>
        ...
        <div className={styles["reco-title-wrap"]}>
          <div className={styles["line"]}></div>
          <div className={styles["reco-text-wrap"]}>
            <div className={styles["reco-icon"]}></div>
            <div className={styles["reco-text"]}>
            为您推荐
            </div>
          </div>
          <div className={styles["line"]}></div>
        ...
        <div className={styles["reco-item-wrap"]}>
          <div className={styles["reco-item"]}>
            <div className={styles["image"]}>
